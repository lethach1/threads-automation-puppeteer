...
(function(exports) {
  ...
  var getElementBox = function(page_1, element_1) {
    ...
    return __awaiter2(void 0, __spreadArray([page_1, element_1], __read(args_1), false), void 0, function(page, element2, relativeToMainFrame) {
      ...
      return __generator2(this, function(_d) {
        switch (_d.label) {
          case 0:
            objectId = element2.remoteObject().objectId;
            if (objectId === void 0) {
              return [2, null];
            }
            _d.label = 1;
          ...
          case 2:
            ...
            return [4, element2.contentFrame()];
          case 3:
...
const humanTypeWithMistakes = async (page, selector, text, mistakeRate = 0.08) => {
  const cursor2 = createGhostCursor(page);
  const element2 = await page.$(selector);
  if (!element2) {
    throw new Error(`Element not found for selector: ${selector}`);
  }
  await cursor2.click(selector);
