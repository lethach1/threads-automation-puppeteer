  ...
  try {
    ...
    for (let i = 0; i < items.length; i++) {
      ...
      if (isFirst) {
        ...
        await page.waitForSelector("div.x1t2pt76:nth-child(2) > div .xqcrz7y .xkqq1k2 .x1lliihq", { timeout: 1e4 });
        await humanDelay(1e3, 2e3);
        await humanClick(page, "div.x1t2pt76:nth-child(2) > div .xqcrz7y .xkqq1k2 .x1lliihq");
